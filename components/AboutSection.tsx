    ...
    <section id="about">
      <div className="my-12 pb-12 md:pt-16 md:pb-48 text-white">
        <h1 className="text-center font-bold text-4xl">
          About Me
          <hr className="w-6 h-1 mx-auto my-4 bg-light-purple border-0 rounded" />
        </h1>
          ...
          <div className="text-center md:w-1/2 md:text-left">
            ...
            <div className="flex flex-wrap flex-row justify-center z-10 md:justify-start cursor-pointer">
              {skills.map((item, idx) => (
                <p
                  key={idx}
                  className="bg-gray-200 px-4 py-2 mr-2 mt-2 text-gray-600 rounded font-bold hover:bg-green-500 hover:text-white hover:font-bold flex items-center"
                >
                  {item.skill}
                </p>
              ))}
